...
tldr: RetroAgent是一个在线强化学习框架，旨在解决LLM智能体在复杂交互任务中容易陷入局部最优且缺乏显式经验学习的问题。该框架通过事后自我反思产生双重内在反馈：数值反馈用于奖励子任务进度，语言反馈则将经验提炼至记忆库。结合SimUtil-UCB检索策略，RetroAgent在多个任务上显著超越了GRPO等基线方法，展现出卓越的进化与泛化能力。
selection_source: fresh_fetch
motivation: 传统的强化学习范式使智能体倾向于静态解决问题而非持续进化，导致探索不足且难以显式利用过往经验。
method: 提出双重内在反馈机制，结合追踪子任务进度的数值奖励和基于SimUtil-UCB策略检索的语言经验记忆库。
result: "在ALFWorld、WebShop等四个挑战性任务上刷新了SOTA，相比GRPO训练的智能体最高提升了27.1%的性能。"
conclusion: RetroAgent通过将解决问题的过程转化为进化的过程，显著提升了智能体在复杂环境中的适应性、探索效率和泛化性能。
---
